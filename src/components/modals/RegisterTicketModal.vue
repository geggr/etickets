        ...
        <form v-show="status.shouldShowForm()" @submit="handleSubmit" class="w-[500px] flex flex-col gap-y-6 p-4">
            ...
            <div>
                <label>
                    ...
                    <input class="block w-full border border-black rounded p-2" type="text" v-model="code"
                        placeholder="#ABC123">
                </label>
            </div>
            ...
            <div>
                <label>
                    <span>Local</span>
                    <input class="block w-full border border-black rounded p-2" type="text" v-model="local"
            ...
            <div>
                <label>
                    <span>Setor</span>
                    <input class="block w-full border border-black rounded p-2" type="text" v-model="place"
